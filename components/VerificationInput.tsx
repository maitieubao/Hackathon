        ...
        <form onSubmit={handleSubmit}>
          ...
          {activeTab === 'link' && (
            <div className="space-y-6">
              {/* Scanner UI */}
              <div className="bg-gray-900 rounded-xl p-6 text-white shadow-inner relative overflow-hidden">
                  {/* Background Grid Effect */}
                  <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(#4fd1c5 1px, transparent 1px)', backgroundSize: '20px 20px' }}></div>
                  ...
                  <div className="relative z-10">
                      ...
                      <div className="flex gap-2">
                          <div className="flex-grow relative">
                              <input
                                  type="url"
                                  className="w-full pl-10 pr-4 py-3 bg-gray-800 border border-gray-700 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 text-white placeholder-gray-500 transition-all font-mono text-sm"
                      ...
                      <div className="mt-4 flex gap-4 text-xs text-gray-400">
                          <div className="flex items-center gap-1">
                              ...
                              Supported: Web, Blogs, Forums
                          </div>
                          <div className="flex items-center gap-1">
                              <span className="w-2 h-2 rounded-full bg-red-500"></span>
                              Blocked: Private Social Media
                          </div>
                      </div>
                  </div>
              </div>
